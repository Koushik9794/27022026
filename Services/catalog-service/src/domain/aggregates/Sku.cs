...
public class Sku
{
    ...
    /// <summary>
    /// JSON schema defining what attributes this SKU type requires.
    /// Used by configuration-service to validate customer input.
    /// Example: { "width": { "type": "number", "unit": "mm", "required": true } }
    /// </summary>
